...
print("Starts with D:")
a = [human.name for human in humans if human.name.find("D") == 0]
print(a)
...
Worthy_Letters = ['C','D','E','F','G']
c = [human.name for human in humans if human.name[0] in Worthy_Letters]
print(c)
...
r = range(27,33)
f = [(human.name, human.age) for human in humans if human.age in r]
print(f)
